...
import { SetupWizard } from "@/components/pos/SetupWizard";
import { LoginPage } from "@/components/pos/LoginPage";
import { POSApp } from "@/components/pos/POSApp";

function AppContent() {
  const { isLoading, isSetupComplete, session, backendDown, refreshSetupStatus } = useAuth();
  ...
  if (backendDown) {
    return <BackendOffline onRetry={refreshSetupStatus} />;
  }
